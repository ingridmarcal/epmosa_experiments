...
if __name__ == "__main__":
    ...
    path_template = "TerceiraGeracao/joda-time/joda-time_{}_buggy"
    graph_path_and_file = "TerceiraGeracao/joda-time/joda-time_{}_buggy/file_graph.json"
    graph_path = "TerceiraGeracao/joda-time/joda-time_{}_buggy"
    output_path = "TerceiraGeracao/joda-time/joda-time_{}_buggy/history_features.csv"
    branch = "HEAD"
