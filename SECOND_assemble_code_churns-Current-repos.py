...
if __name__ == "__main__":
    ...
    with Manager() as manager:
        ...
        for i in range(1, 2):
            ...
            GRAPH_PATH_FILE = "current_repos/commons-compress/file_graph.json"
            GRAPH_PATH = "current_repos/commons-compress"
            OUTPUT = "current_repos/commons-compress/code_churns_features_multithread.csv"
