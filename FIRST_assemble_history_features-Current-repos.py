...
def get_history_features(graph, repo_path, branch):
    ...
    save_commit_timestamps(commit_timestamp, "current_repos/commons-lang/commit_timestamps.csv")
    return features
...
if __name__ == "__main__":
    ...
    for i in range(1, 65):
        ...
        REPO_PATH = "current_repos/commons-lang"
        BRANCH = "refs/heads/master"
        GRAPH_PATH_FILE = "current_repos/commons-lang/file_graph.json"
        GRAPH_PATH = "current_repos/commons-lang"
        OUTPUT = "current_repos/commons-lang/history_features.csv"
