...
project_names=("commons-collections")
n_bugs=(4)
...
for ((i=0; i<${#identifiers[@]}; i++)); do
    ...
    for ((nb=1; nb<=${n_bugs[$i]}; nb++)); do
		...
		cd ../
        cp -v "/home/ingridmarcal/Documents/budgets.txt" "/home/ingridmarcal/Documents/PrimeiraGeracao/${project_names[$i]}/${project_names[$i]}_${nb}_buggy/budgets.txt"
